...
minus.addEventListener("click",
    ...
    heart.addEventListener("click", function () {
        var a = document.getElementById("counter"),
            ...
            d = void 0;
        if ([].concat(_toConsumableArray(c.children)).map(function
            (a) { return parseInt(a.dataset.num) }).includes(b))
        {
    ...
    pause.addEventListener("click",
        function () {
            playing ? (playing = !1,
                ...
                [].concat(_toConsumableArray(document.getElementsByTagName("button"))).forEach(function
                    (a) { "pause" !== a.id && (a.disabled = !playing) })
        }),
